            ...
            <div className="grid items-center gap-12 md:grid-cols-2">
              <div>
                <h2 className="mb-4 font-headline text-4xl font-bold md:text-5xl text-primary">
                  Welcome to Rose Escorts
                </h2>
                <p className="mb-4 text-muted-foreground">
                  Here at Rose Escorts we take immense pride in our commitment to providing an unparalleled level of service. Our dedicated community of long-term clients is a testament to our consistent excellence and the quality of experiences we provide.
                </p>
                <p className="mb-4 text-muted-foreground">
                ...
                <p className="text-muted-foreground">
                  At Rose Escorts, we deeply value repeat clientele. Discretion, mutual respect, and professionalism are the cornerstones of our business, and we are committed to maintaining the highest standards in all our interactions.
                </p>
              </div>
