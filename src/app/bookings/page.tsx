            ...
            <div className="grid gap-12 md:grid-cols-2">
              ...
              <div>
                ...
                <p className="mx-auto mb-4 max-w-3xl md:max-w-5xl text-foreground text-lg md:text-xl">
                    At Rose Escorts, we believe in inclusivity and discretion. Your age, body type, appearance, or background are not determining factors in our engagement. We welcome respectful adults from all walks of life.
                </p>
                <p className="mx-auto mb-4 max-w-3xl md:max-w-5xl text-foreground text-lg md:text-xl">
